#Hoje vou aprender usar um while dentro de outro while
...
while i < n:
    ...
    while j < n:
        ...
        j = j + 1
    i = i + 1
#Já que o ciclo while do j está dentro do ciclo while i, ele
#ele printa na tela que para o valor de j para cada valor de i
#Eu criei um  Nested while loops

#Veja a seguir onde podemos usar o Nested While
...
while empresa <= n:
    ...
    if balança == 0:
        ...
        print ('A empresa', empresa, 'fechou com o lucro de R$', balança)
    else:
        print ('A empresa', empresa, 'fechou com o défict de R$', balança)
