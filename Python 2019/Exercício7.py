...
print ('As notas do caixa são.:',a,',',b,',',c,',',d,',',e)
print('')
...
print ('Seu saque é de',nota01,'notas de 1.')
print('ou')
print ('Seu saque é de',nota02,'notas de 5.')
print('ou')
print ('Seu saque é de',nota03,'notas de 10.')
print('ou')
print ('Seu saque é de',nota04,'notas de 50.')
print('ou')
print ('Seu saque é de',nota05,'notas de 100.')
print ('')
